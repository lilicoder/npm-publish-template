...
import {Icon, Tooltip, Form, InputNumber} from "tinper-bee";
...
class NumberEditGridCell extends Component {
    ...
    render() {
        ...
        const {
            hidden, disabled, required, colName, colCode,
            initialValue, form: {getFieldsError,  getFieldProps}, precision, onChange
        } = this.props;
            ...
            <div className="editable-cell">
                <div className={cls}>
                    <InputNumber
                        {...opt}
                        precision={
                            !precision || precision === "" ? 0 : parseInt(precision)
                        }
                        min={0}
                        iconStyle="one"
                        {
